...
import tn.esprit.Apollo.persistence.WhishList;
	...
	public class WhishListLoggerListener {
		@PostPersist
		public void methodInvokedAfterPersist(WhishList WhishList) {

			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			Audit audit = new Audit();
			audit.setObj(WhishList);
		...
		@PostLoad
		public void methodInvokedBeforeLoad(WhishList WhishList) {
		...
		@PreRemove
		private void methodInvokedBeforeRemove(WhishList WhishList) {
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			Audit audit = new Audit();
			audit.setObj(WhishList);
