...
import tn.esprit.Apollo.persistence.Rating;
	...
	public class RatingLoggerListener {

		@PostPersist
		public void methodInvokedAfterPersist(Rating Rating) {
		...
		@PostLoad
		public void methodInvokedBeforeLoad(Rating Rating) {
		...
		@PreRemove
		private void methodInvokedBeforeRemove(Rating Rating) {
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			Audit audit = new Audit();
			audit.setObj(Rating);
