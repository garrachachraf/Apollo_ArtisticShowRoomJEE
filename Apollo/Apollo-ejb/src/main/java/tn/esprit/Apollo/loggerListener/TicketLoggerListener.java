...
import tn.esprit.Apollo.persistence.Ticket;
	...
	public class TicketLoggerListener {

		@PostPersist
		public void methodInvokedAfterPersist(Ticket Ticket) {
		...
		@PostLoad
		public void methodInvokedBeforeLoad(Ticket Ticket) {
		...
		@PreRemove
		private void methodInvokedBeforeRemove(Ticket Ticket) {
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			Audit audit = new Audit();
			audit.setObj(Ticket);
