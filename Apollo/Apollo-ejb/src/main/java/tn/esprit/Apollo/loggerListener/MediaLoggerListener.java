...
import tn.esprit.Apollo.persistence.Media;
	...
	public class MediaLoggerListener {

		@PostPersist
		public void methodInvokedAfterPersist(Media Media) {
		...
		@PostLoad
		public void methodInvokedBeforeLoad(Media Media) {
		...
		@PreRemove
		private void methodInvokedBeforeRemove(Media Media) {
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			Audit audit = new Audit();
			audit.setObj(Media);
